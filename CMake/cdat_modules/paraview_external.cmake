...
# Use cdat libxml
if(SB_ENABLE_LIBXML2 STREQUAL "ON")
  list(APPEND ParaView_tpl_args
...
if(SB_ENABLE_HDF5 STREQUAL "ON")
  ...
  list(APPEND ParaView_tpl_args
    ...
    -DHDF5_hdf5_LIBRARY:FILEPATH=${HDF5_hdf5_LIBRARY}
    -DHDF5_hdf5_LIBRARY_RELEASE:FILEPATH=${HDF5_hdf5_LIBRARY_RELEASE}
  )
endif()
