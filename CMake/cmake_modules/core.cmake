...
macro(add_sb_package)
  ...
  if(SB_ENABLE_${uc_package_name} STREQUAL "SYSTEM")
    ...
    # Python package so query Python for installed version
      ...
      python_package_version(${lc_package_name} _installed_version)
      ...
      if(_installed_version)
        if(NOT "" STREQUAL "${_version}")
          if(_installed_version VERSION_EQUAL _version OR
            ...
            message(FATAL_ERROR "[sb:error] Unable to find required version Python package ${lc_package_name}, ${_version} is required, ${_installed_version} is installed")
          endif()
        else()
          message(WARNING "[sb:warning] No required version specified for Python package ${lc_package_name}")
        endif()
      else()
          message(FATAL_ERROR "[sb:error] Unable to find Python package ${lc_package_name}")
      endif()
    endif()
  endif()
endmacro()
