...
def makeTables(modelpath, obspath, outpath, pname, outlog, errlog):
   if pname.upper() == 'AMWG':
      ...
      for reg in regions:
         cmdline = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s --set 1 --package AMWG %s --outputdir %s --region %s' % (modelpath, obspath, seasons, outpath, reg)
   ...
   #                  print obsfname
         ...
         if setnum != 'topten' and setnum != 'so' and setnum != 'testing':
            ...
            if v4 != []:
               ...
               vl = vl1
               vlstr2 = ' '.join(vl2)
               cmdline2 = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s %s --set 5 %s %s --vars %s %s %s %s %s' % (modelpath, obspath, package, seasons, obsfname, vlstr2, outdir, postname, xml, prename)
            elif v5 != []:
               realsetnum = 5
            ...
            if v4 != []:
               ...
               vl = vl1
               vlstr2 = ' '.join(vl2)
               cmdline2 = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s %s --set 5 %s %s --vars %s %s %s %s %s --regions %s' % (modelpath, obspath, package, seasons, obsfname, vlstr2, outdir, postname, xml, prename, '\'southern extratropics\'')
            elif v5 != []:
               realsetnum = 5
               vl = list(set(v5) & set(vl))
            elif v6 != []:
            ...
            if v4 != []:
               ...
               vl = vl1
               vlstr2 = ' '.join(vl2)
               cmdline2 = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s %s --set 5 %s %s --vars %s %s %s %s %s --regions %s' % (modelpath, obspath, package, seasons, obsfname, vlstr2, outdir, postname, xml, prename, '\'Amazonia\'')
            elif v3 != []:
               realsetnum = 3
         ...
         vlstr = ' '.join(vl)
         if setnum == 'so':
            cmdline = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s %s --set %s %s %s --vars %s %s %s %s %s --regions %s' % (modelpath, obspath, package, realsetnum, seasons, obsfname, vlstr, outdir, postname, xml, prename, '\'southern extratropics\'')
         elif setnum == 'testing':
            cmdline = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s %s --set %s %s %s --vars %s %s %s %s %s --regions %s' % (modelpath, obspath, package, realsetnum, seasons, obsfname, vlstr, outdir, postname, xml, prename, '\'southern extratropics\'')
         else:
            cmdline = '/ccs/home/sburrows/uvcdat-testing/diags.py --path %s --path2 %s %s --set %s %s %s --vars %s %s %s %s %s' % (modelpath, obspath, package, realsetnum, seasons, obsfname, vlstr, outdir, postname, xml, prename)
