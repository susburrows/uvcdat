...
varinfo['SHFLX']={'desc':'Surface sensible heat flux', 'sets': ['5', '3', '10', '15', 'so'], 'obssets': {
	'JRA25 Reanalysis 1979-04': {
...
varinfo['AODVIS']={'desc':'Aerosol optical depth', 'sets': ['topten', 'so', 'testing'], 'obssets': {
	'AOD_550': {
		'filekey': 'sat', 'usedin': ['topten', 'so', 'testing']}
}}
