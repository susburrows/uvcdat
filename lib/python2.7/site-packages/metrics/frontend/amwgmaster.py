...
amwgsets['so']={'preamble':'', 'desc':'Tier 1B Diagnostics: Southern Ocean', 'seasons':'NA'}
...
varinfo['SHFLX_SOUTH']={'desc':'Surface sensible heat flux (Southern)', 'sets': ['7','so'], 'obssets': {
	'Large-Yeager 1984-2004': {
		'filekey': 'LARYEA', 'usedin': ['7','so']}
}}
...
varinfo['QFLX_SOUTH']={'desc':'Surface water flux (Southern)', 'sets': ['7','so'], 'obssets': {
	'Large-Yeager 1984-2004': {
		'filekey': 'LARYEA', 'usedin': ['7', 'so']}
}}
...
varinfo['FSNS']={'desc':'Surf Net SW flux', 'sets': ['5', '3', '10','so'], 'obssets': {
	'ISCCP FD Jul1983-Dec2000': {
		'filekey': 'ISCCP', 'usedin': ['5', '3', '10']},
	'Large-Yeager 1984-2004': {
		'filekey': 'LARYEA', 'usedin': ['5', '3', '10', 'so']}
}}
varinfo['FLDS_SOUTH']={'desc':'Surf LW downwelling flux (Southern)', 'sets': ['7','so'], 'obssets': {
	'ISCCP FD Jul1983-Dec2000': {
		'filekey': 'ISCCP', 'usedin': ['7','so']}
}}
...
varinfo['T']={'desc':'Temperature', 'sets': ['4a', '4', '15', 'topten','so'], 'obssets': {
	'NCEP Reanalysis 1979-98': {
		'filekey': 'NCEP', 'usedin': ['4a', '4']},
	'ERAI Interim Reanalysis': {
		'filekey': 'ERAI', 'usedin': ['topten','so']},
...
varinfo['SWCF']={'desc':'TOA shortwave cloud forcing', 'sets': ['5', '3', '9', '10', 'topten','so'], 'obssets': {
	'ERBE Feb1985-Apr1989': {
...
varinfo['SHFLX']={'desc':'Surface sensible heat flux', 'sets': ['5', '3', '10', '15'], 'obssets': {
	'JRA25 Reanalysis 1979-04': {
...
varinfo['RELHUM']={'desc':'Relative humidity', 'sets': ['4a', '4', 'topten'], 'obssets': {
	'ECMWF Reanalysis 1979-93': {
		'filekey': 'ECMWF', 'usedin': ['4a', '4']},
	'NCEP Reanalysis 1979-98': {
		'filekey': 'NCEP', 'usedin': ['4a', '4']},
...
varinfo['QFLX']={'desc':'Surface water flux', 'sets': ['5', '3', '10'], 'obssets': {
	'Woods Hole OAFLUX 1958-2006': {
		'filekey': 'WHOI', 'usedin': ['5', '3', '10']},
	'ECMWF Reanalysis 1979-93': {
...
varinfo['PRECT']={'desc':'Precipitation rate', 'sets': ['5', '3', '8', '9', '10', '15', 'topten', 'so'], 'obssets': {
	'CMAP (Xie-Arkin) 1979-98': {
		'filekey': 'XA', 'usedin': ['5', '3', '8', '9', '10']},
	'GPCP 1979-2003': {
		'filekey': 'GPCP', 'usedin': ['5', '3', '8', '9', '10', 'topten', 'so']},
...
varinfo['FLDS']={'desc':'Surf LW downwelling flux', 'sets': ['5', '3', '10', '15'], 'obssets': {
	'Surface Heat Budget of the Arctic Ocean (SHEBA)': {
		'filekey': 'SHEBA', 'usedin': ['15']},
	'ISCCP FD Jul1983-Dec2000': {
		'filekey': 'ISCCP', 'usedin': ['5', '3', '10']},
...
varinfo['OMEGA']={'desc':'Pressure vertical velocity', 'sets': ['4a', '4'], 'obssets': {
	'ECMWF Reanalysis 1979-93': {
		'filekey': 'ECMWF', 'usedin': ['4a', '4']},
	'NCEP Reanalysis 1979-98': {
		'filekey': 'NCEP', 'usedin': ['4a', '4']},
...
varinfo['TREFHT']={'desc':'2-meter air temperature (land)', 'sets': ['5', '3', '9', '10', 'topten'], 'obssets': {
	'Willmott and Matsuura 1950-99': {
		'filekey': 'WILLMOTT', 'usedin': ['5', '3', '10', 'topten']},
	'Legates and Willmott 1920-80': {
...
varinfo['SURF_WIND_SOUTH']={'desc':'Near surface wind (Southern)', 'sets': ['7', 'so'], 'obssets': {
	'NCEP Reanalysis 1979-98': {
		'filekey': 'NCEP', 'usedin': ['7', 'so']}
}}
...
varinfo['SURF_STRESS']={'desc':'Surface wind stress (ocean)', 'sets': ['6', 'topten', 'so'], 'obssets': {
	'NCEP Reanalysis 1979-98': {
		'filekey': 'NCEP', 'usedin': ['6']},
	'JRA25 Reanalysis 1979-04': {
		'filekey': 'JRA25', 'usedin': ['6']},
	'Large-Yeager 1984-2004': {
		'filekey': 'LARYEA', 'usedin': ['6']},
	'ERS Scatterometer 1992-2000': {
		'filekey': 'ERS', 'usedin': ['6', 'topten', 'so']}
}}
varinfo['CLDTOT_SOUTH']={'desc':'Total cloud amount (IR clouds) (Southern)', 'sets': ['7', 'so'], 'obssets': {
	'ISCCP D2 1983-2001': {
		'filekey': 'ISCCP', 'usedin': ['7']},
	'Warren Cloud Surface OBS': {
		'filekey': 'WARREN', 'usedin': ['7']},
	'CLOUDSAT (Radar+Lidar) Sep2006-Nov2008': {
		'filekey': 'CLOUDSAT', 'usedin': ['7', 'so']}
}}
varinfo['PREH2O']={'desc':'Total precipitable water', 'sets': ['5', '3', '8', '9', '10'], 'obssets': {
	...
	'JRA25 Reanalysis 1979-04': {
		'filekey': 'JRA25', 'usedin': ['5', '3', '8', '9', '10']},
	'ERA40 Reanalysis 1980-2001': {
...
varinfo['SHUM']={'desc':'Specific humidity', 'sets': ['4a', '4'], 'obssets': {
	'ECMWF Reanalysis 1979-93': {
		'filekey': 'ECMWF', 'usedin': ['4a', '4']},
	'JRA25 Reanalysis 1979-04': {
		'filekey': 'JRA25', 'usedin': ['4a', '4']},
...
varinfo['CLDTOT']={'desc':'Mid cloud amount (IR clouds)', 'sets': ['5', '3', '9', '10', '15'], 'obssets': {
	'Tropical Western Pacific--Region 1 (TWP1)': {
		'filekey': 'TWP1', 'usedin': ['15']},
	'Tropical Western Pacific--Region 3 (TWP3)': {
		'filekey': 'TWP3', 'usedin': ['15']},
