...
class derived_var(basic_id):
    def __init__( self, vid, inputs=[], outputs=['output'], func=(lambda: None), special_value=None, regionid=None ):
        """Arguments:
    ...
    def derive( self, inpdict ):
        ...
        if type(output) is tuple or type(output) is list:
            ...
            output = select_region(output , self.region)
