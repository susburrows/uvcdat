...
def reduce2scalar_seasonal_zonal_region( mv, seasons=seasonsyr, region, vid=None, gw=None ):
    mvr = select_region(mv, region)
    mvrssz = reduce2scalar_seasonal_zonal( mv, seasons=seasonsyr, latmin=region[0], latmax=region[1], vid, gw)
    return mvrssz
...
def reduce2levlat_seasonal_region( mv, seasons=seasonsyr, region=None, vid=None ):
    mvr = select_region(mv, region)
    mvllsr = reduce2levlat_seasonal( mvr, seasons=seasonsyr, vid )
    return mvllsr
