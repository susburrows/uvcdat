...
def reduce2latlon_region(mv, region=None, vid=None):
    mvr = select_region(mv, region)
    mvrll = reduce2latlon(mvr, vid)
    return mvrll
...
def reduce_seasonal_region( mv, season, region=None, vid=None ):
    ...
    mvtreg = delete_singleton_axis(mvtreg, vid='time')
    mvtreg = delete_singleton_axis(mvtreg, vid=levax)
